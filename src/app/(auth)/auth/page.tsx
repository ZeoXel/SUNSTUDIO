      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="flex items-end justify-center gap-4 mb-10">
          ...
          <div className="flex items-end h-12">
            <h1 className="text-[26px] font-semibold tracking-tight leading-none text-slate-800 dark:text-slate-100">
              {brand.namePrefix}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500 font-extrabold">
                {brand.nameHighlight}
              </span>
            </h1>
          </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-700 p-6">
          ...
          {success && (
            <div className="mb-4 p-3 bg-emerald-50 dark:bg-emerald-900/20 rounded-lg text-sm text-emerald-600 dark:text-emerald-400">
              {success}
            </div>
          )}
